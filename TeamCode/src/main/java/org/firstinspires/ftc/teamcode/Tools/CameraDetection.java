...
import org.firstinspires.ftc.teamcode.ConstantsVision;
...
@TeleOp
public abstract class CameraDetection extends LinearOpMode  {
    ...
    public static void update(){
        ...
        for (AprilTagDetection detection : tagProcessor.getDetections()) {
            if (detection.rawPose != null) {
                ...
                CorrectX = ConstantsVision.yCorrected(pose.y);
                CorrectY = -ConstantsVision.xCorrected(pose.x);
